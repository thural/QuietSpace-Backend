...
public class ChatControllerWs {
    ...
    void sendMessageToUser(@Payload MessageRequest message) {
        ...
        try {
            ...
            // will send to /user/userId/private/chat-<session-id>, session-id is autogenerated at login
            template.convertAndSendToUser(String.valueOf(message.getRecipientId()), CHAT_PATH, savedMessage);
        } catch (Exception e) {
    ...
    void deleteMessageById(@Payload ChatEvent chatEvent) {
        log.info("deleting message with id {} ...", chatEvent);
        var chatevent = ChatEvent.builder()
